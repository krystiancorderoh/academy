...
<%
    ...
    if (request.getParameter("save") == null) {
        state = stateService.getState(NumberUtils.createLong(request.getParameter("stateId")));
        ...
        try {
            ...
            state = stateService.update(stateId, stateDesc);
...
<body>
	...
	<form method="post" action="">
        <table style="width: 40%;">
            ...
            <tr>
                <td>Description</td>
                <td><input type="text" name="description" value="${state.description}"></td>
            </tr>
        </table>
